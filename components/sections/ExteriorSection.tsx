  ...
  return (
    <div className="flex max-w-screen-lg m-auto">
      <div className="f-right col-1-2 left pr-10">
        ...
        <br />
        <p>
          Exteriors, exposed to rain and harsh elements means the exteriors have
          to be more durable. We always use top quality paints, tough fillers
          and materials to make sure the paint job will last as long as
          possible.
        </p>
        <br />
        <p>
