import backgroundImage from "../../assets/hero.png"; // Replace with the actual path to your image
...
const LandingSection: React.FC = () => {
  return (
    ...
    >
      <div className="max-w-screen-lg max-lg:max-w-screen-sm flex items-center max-sm:px-4 m-auto h-[600px] max-lg:h-[450px]">
